#ifndef AGGRESSOR_RECOVER_BALL_SKILL_H
#define AGGRESSOR_RECOVER_BALL_SKILL_H

#include "skill.h"
class AggressorRecoverBallSkill : public Skill
{
public:
 static int skillNum;
...
/**@name	public functions  */
  ...
  AggressorRecoverBallSkill(const SystemParameters *rp,
                            VisionModule *vm, 
 ...
 /**Indicates if the skill is still viable (whether it is frustrated or not).
  ...
  char* getName() const { 
	  return "AggressorRecoverBallSkill"; 
  }
  //}@
protected:
...
#endif //AGGRESSOR_RECOVER_BALL_SKILL_H