#ifndef CREATOR_PASS_SKILL_H
#define CREATOR_PASS_SKILL_H

#include "skill.h"



class CreatorPassSkill : public Skill
{
public:
  ...
  CreatorPassSkill(SystemParameters *sp,
                          VisionModule *vm, 
