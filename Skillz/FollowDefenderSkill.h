#ifndef FOLLOW_DEFENDER_SKILL_H
#define FOLLOW_DEFENDER_SKILL_H

#include "skill.h"
class FollowDefenderSkill : public Skill
{
public:
 static int skillNum;
...
/**@name	public functions  */
  ...
  FollowDefenderSkill(SystemParameters *sp,
                  VisionModule *vm, 
