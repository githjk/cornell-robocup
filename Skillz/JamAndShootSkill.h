#ifndef JAM_AND_SHOOT_SKILL_H
#define JAM_AND_SHOOT_SKILL_H

#include "skill.h"
class JamAndShootSkill : public Skill
{
public:
 static int skillNum;
...
/**@name	public functions  */
  ...
  JamAndShootSkill(SystemParameters *sp,   
                   VisionModule *vm, 
