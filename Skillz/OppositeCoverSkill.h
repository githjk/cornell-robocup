#ifndef OPPOSITE_COVER_SKILL_H
#define OPPOSITE_COVER_SKILL_H

#include "skill.h"
class OppositeCoverSkill : public Skill
{
public:
 static int skillNum;
...
/**@name	public functions  */
  ...
  OppositeCoverSkill(SystemParameters *sp,
                  VisionModule *vm, 
