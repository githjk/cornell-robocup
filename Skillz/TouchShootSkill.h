#ifndef TOUCH_SHOOT_SKILL_H
#define TOUCH_SHOOT_SKILL_H

#include "skill.h"
class TouchShootSkill : public Skill
{
public:
 static int skillNum;
...
/**@name	public functions  */
  ...
  TouchShootSkill(SystemParameters *sp,
                  VisionModule *vm, 
