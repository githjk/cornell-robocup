...
Play BackPass::playNum = -1;

BackPass::BackPass(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void BackPass::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void BackPass::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
...
void BackPass::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/BackPassParams.txt", ios::nocreate);  
