//*********************************************************
#include "penaltyShotThemDiveRight2002.h"
#include "../basic_actions.h"
Play PenaltyShotThemDiveRight2002::playNum = -1;

PenaltyShotThemDiveRight2002::PenaltyShotThemDiveRight2002(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void PenaltyShotThemDiveRight2002::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void PenaltyShotThemDiveRight2002::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
...
//*********************************************************
// Get Action Function
ActionFunction PenaltyShotThemDiveRight2002::getActionFunction(Position pos)
{
  switch(pos)
  {
    case BLOCKER: return Blocker::penaltyShotThemDiveRight2002;  
...
void PenaltyShotThemDiveRight2002::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/PenaltyShotThemDiveRight2002Params.txt", ios::nocreate);  
