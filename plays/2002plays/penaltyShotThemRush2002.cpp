//*********************************************************
#include "penaltyShotThemRush2002.h"
#include "../basic_actions.h"
Play PenaltyShotThemRush2002::playNum = -1;

PenaltyShotThemRush2002::PenaltyShotThemRush2002(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void PenaltyShotThemRush2002::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void PenaltyShotThemRush2002::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
...
//*********************************************************
// Get Action Function
ActionFunction PenaltyShotThemRush2002::getActionFunction(Position pos)
{
  switch(pos)
  {
    case BLOCKER: return Blocker::penaltyShotThemRush2002;  
...
void PenaltyShotThemRush2002::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/PenaltyShotThemRush2002Params.txt", ios::nocreate);  
