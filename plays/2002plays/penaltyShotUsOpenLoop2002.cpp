//*********************************************************
#include "penaltyShotUsOpenLoop2002.h"
#include "../basic_actions.h"
Play PenaltyShotUsOpenLoop2002::playNum = -1;

PenaltyShotUsOpenLoop2002::PenaltyShotUsOpenLoop2002(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void PenaltyShotUsOpenLoop2002::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void PenaltyShotUsOpenLoop2002::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
  standardExecution(*vision, rsd);
}
//*********************************************************
// Get Action Function
ActionFunction PenaltyShotUsOpenLoop2002::getActionFunction(Position pos)
{
  switch(pos)
  {
    case BLOCKER: return Blocker::penaltyShotUs2002;  
    case DEFENDER: return Defender::penaltyShotUs2002;
    case AGGRESSOR: return Aggressor::penaltyShotUsOpenLoop2002;
...
void PenaltyShotUsOpenLoop2002::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/PenaltyShotUsOpenLoop2002Params.txt", ios::nocreate);  
