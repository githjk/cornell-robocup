//*********************************************************
#include "penaltyShotUsPivot2002.h"
#include "../basic_actions.h"
Play PenaltyShotUsPivot2002::playNum = -1;

PenaltyShotUsPivot2002::PenaltyShotUsPivot2002(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void PenaltyShotUsPivot2002::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void PenaltyShotUsPivot2002::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
...
//*********************************************************
// Get Action Function
ActionFunction PenaltyShotUsPivot2002::getActionFunction(Position pos)
{
  switch(pos)
  {
    case BLOCKER: return Blocker::penaltyShotUs2002;  
    case DEFENDER: return Defender::penaltyShotUs2002;
    case AGGRESSOR: return Aggressor::penaltyShotUsPivot2002;
...
void PenaltyShotUsPivot2002::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/PenaltyShotUsPivot2002Params.txt", ios::nocreate);  
