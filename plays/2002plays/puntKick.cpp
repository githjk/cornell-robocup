...
Play PuntKick::playNum = -1;

PuntKick::PuntKick(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void PuntKick::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)
...
//*********************************************************
// Execute Play
void PuntKick::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
...
//*********************************************************
// Get Action Function
ActionFunction PuntKick::getActionFunction(Position pos)
{
  switch(pos)
  {
    case BLOCKER: return Blocker::puntKick;  
    case DEFENDER: return Defender::puntKick;
    case AGGRESSOR: return Aggressor::puntKick;
    case CREATOR: return Creator::puntKick; 
...
void PuntKick::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/PuntKickParams.txt", ios::nocreate);  
