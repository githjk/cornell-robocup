#include "singleAssistOffense.h"
#include "../basic_actions.h"
Play SingleAssistOffense::playNum = -1;


SingleAssistOffense::SingleAssistOffense(VisionModule *vm) : BasePlay(vm)
{
   loadValues();
}
...
//*********************************************************
// Initialize Play
void SingleAssistOffense::initializePlay(const VisionData& vision, RobocupStrategyData* rsd)  
{
  timer->resetTimer();
...
//*********************************************************
// Execute Play
void SingleAssistOffense::executePlay(VisionData* vision, RobocupStrategyData* rsd)
{
  standardExecution(*vision, rsd);
}
//*********************************************************
// Get Action Function
ActionFunction SingleAssistOffense::getActionFunction(Position pos)
{
	switch(pos)
	{
  	case BLOCKER: return Blocker::singleAssistOffense;  
  	case DEFENDER: return Defender::singleAssistOffense;
	  case AGGRESSOR: return Aggressor::singleAssistOffense;
  	case CREATOR: return Creator::singleAssistOffense; 
...
void SingleAssistOffense::loadValues()
{
  ///Open the paramater file:
  ifstream mainFile;
  mainFile.open("Params/Play_Params/2002plays/SingleAssistOffenseParams.txt", ios::nocreate);  
