...
#ifndef PLAYS_PENALTY_SHOT_US_H
#define PLAYS_PENALTY_SHOT_US_H

#include "../baseplay.h"
#include "../basic_actions.h"
#include "math/angle.h"

class PenaltyShotUs : public BasePlay 
{
public:
  static Play playNum;

  PenaltyShotUs(VisionModule *vm) : BasePlay(vm)
  {
  }
  ...
  char* getName() const 
  {
    return "Penalty Shot Us Formation"; 
  }
