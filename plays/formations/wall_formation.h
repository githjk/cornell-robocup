...
#ifndef PLAYS_WALL_FORMATION_H
#define PLAYS_WALL_ORMATION_H

#include "../baseplay.h"
#include "../basic_actions.h"

class WallFormation : public BasePlay 
{
public:
  static Play playNum;

  WallFormation(VisionModule *vm) : BasePlay(vm) { }

  Play getID()  const{ return playNum; }

  char* getName() const{ return "Wall Formation"; }
